                ...
                <div class="mb-3">
                    <div class="mb-3">
                        ...
                        <div class="row ms-0 me-0 col-md-6">
                            <input type="text" required class="form-control" id="location" name="location" placeholder="Eg. Pune/Mumbai">
                        </div>
                    </div>
                    <div class="mb-3 col">
                ...
                <div class="mb-3">
                    <div class="mb-3">
                        ...
                        <div class="row ms-0 me-0 col-md-6">
                            ...
                            <input type="number" required name="minsalary" class="form-control col" id="minsalary" placeholder="80000">
                            <div class="col-auto pt-2" style="background-color: lightgray;">To</div>
                            <input type="number" required name="maxsalary" class="form-control col" id="maxsalary" placeholder="90000">
                        </div>
                    </div>
                </div>
            </div>
            <div class="step">
                ...
                <div class="mb-3">
                    ...
                    <div class="row ms-0 me-0 col-md-6">
                        ...
                        <input type="number" required class="form-control col" name="minyr" id="minyr" placeholder="0">
                        <div class="col-auto pt-2" style="background-color: lightgray;">-</div>
                        <input type="number" required class="form-control col" name="maxyr" id="maxyr" placeholder="3">
                    </div>
                </div>
                <div class="mb-3 col-md-6">
                    <label for="vacancy" class="form-label">Vacancy:</label>

                    <input type="number" required class="form-control " name="vacancy" id="vacancy" placeholder="Max number of vacancy">
